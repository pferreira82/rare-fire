                    ...
                    if (window.innerWidth >= responsiveThreshold) {
                        ...
                        if ($this.hasClass('title-transition')) {
                            ...
                            currentTransitions[dataId] = {
                                ...
                                sceneTweenPairs: [{scene: scene, tween: tweenZoomOut}, {
                                    scene: scene2,
                                    tween: tweenFadeHeader
                            ...
                            elementTransitions.each(function () {
                                tweenElementTimeline.to(this, 1, {
                                    className: "+=active",
            ...
            function initMap(mapEl, roadColor, landColor, lat, lng, tooltip) {
                ...
                var styleArray = [
                    ...
                    {"featureType": "administrative", "stylers": [{"visibility": "off"}]},
                    {
                        ...
                        "stylers": [{"color": roadColor}, {"saturation": "-30"}, {"lightness": "30"}]
                    },
                    {
                        "featureType": "road",
